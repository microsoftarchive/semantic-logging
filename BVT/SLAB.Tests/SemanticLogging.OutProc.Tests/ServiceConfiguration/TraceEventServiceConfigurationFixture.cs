...
{
    [TestClass]
    public class TraceEventServiceConfigurationFixture
    {
        [TestMethod]
        public void SessionNameIsLongerThan200Chars()
        {
        ...
        [TestMethod]
        public void OneSessionNameIslongOtherIsNot()
        {
        ...
        [TestMethod]
        public void BasicConfigWrongTypeInFormatterParameterNoClass()
        {
        ...
        [TestMethod]
        public void BasicConfigWrongTypeInFormatterParameter()
        {
            var exc = ExceptionAssertHelper.Throws<ConfigurationException>(() => TraceEventServiceConfiguration.Load("Configurations\\WithWrongFormatterParameter.xml"));

            StringAssert.Contains(exc.ToString(), "One or more errors occurred when loading the TraceEventService configuration file.");
            StringAssert.Contains(exc.ToString(), "Could not load type 'Microsoft.Practices.EnterpriseLibrary.SemanticLogging.Formatters.Foo' from assembly 'Microsoft.Practices.EnterpriseLibrary.SemanticLogging'.");
        }
        ...
        [TestMethod]
        public void BasicConfigWrongFormatter()
        {
        ...
        [TestMethod]
        public void BasicConfigMissingListener()
        {
        ...
        [TestMethod]
        public void BasicConfigOnylGuidIsAccepted()
        {
        ...
        [TestMethod]
        public void BasicConfigNoEventSourceIdentifier()
        {
        ...
        [TestMethod]
        public void BasicConfigDefaultValues()
        {
        ...
        [TestMethod]
        public void BasicConfigDefaultValuesNoGuid()
        {
            var logger = MockEventSourceOutProc.Logger;
        ...
        [TestMethod]
        public void TwoSinksWithTheSameName()
        {
        ...
        [TestMethod]
        public void OutProcCustomSchemaValidationWrongAttr()
        {
        ...
        [TestMethod]
        public void OutProcCustomSchemaValidationMissingAttr()
        {
